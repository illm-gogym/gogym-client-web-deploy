...
class ScheduleMember extends React.Component {
	...
	getTrainerUserAllApi = async () => {
		try{
			...
			const result = await axios.get("http://gogym.co.kr:8080/api/auth/trainer/userall", requestOption )
				.then(res =>{
	...
	addUserReservationApi = async () => {
		try{
			...
			await axios.post("http://gogym.co.kr:8080/api/auth/reservation/add" ,
